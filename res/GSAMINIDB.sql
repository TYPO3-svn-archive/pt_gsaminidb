 ...
 * Database: `GSAMINIDB`
 * 
 * SQL script to import to your MySQL database server in order to create a 
 * minimal GSA database to run the "General Shop Applications (GSA)" Extensions 
 * as a TYPO3 standalone version with a _separate_ database (additional to 
 * your existing TYPO3 database).
 * 
 * $Id: GSAMINIDB.sql,v 1.10 2009/02/27 08:48:41 ry37 Exp $
 *****************************************************************************/


/*
 * To use a special character set and/or collation for this database 
 * you may complement the following CREATE DATABASE statement,
 * e.g. CREATE DATABASE `GSAMINIDB` CHARACTER SET utf8;
 * see http://dev.mysql.com/doc/refman/5.1/en/charset-database.html
 */
CREATE DATABASE `GSAMINIDB`; 
USE `GSAMINIDB`;
...
/*********************************************************
 * Table structure for table `ANSCH`
 ********************************************************/
...
/*********************************************************
 * Table structure for table `BHSTEUER`
 ********************************************************/

CREATE TABLE `BHSTEUER` (
...
/**
 * Data for table `BHSTEUER`
 */

INSERT INTO `BHSTEUER` VALUES (1, '00', '0.0000', '1993-01-01');
INSERT INTO `BHSTEUER` VALUES (2, '01', '15.0000', '1980-01-01');
INSERT INTO `BHSTEUER` VALUES (3, '01', '16.0000', '1998-04-01');
INSERT INTO `BHSTEUER` VALUES (4, '01', '19.0000', '2007-01-01');
INSERT INTO `BHSTEUER` VALUES (5, '02', '6.5000', '1980-01-01');
INSERT INTO `BHSTEUER` VALUES (6, '02', '7.0000', '1993-01-01');
...
/*********************************************************
 * Table structure for table `FSCHRIFT`
 ********************************************************/

CREATE TABLE `FSCHRIFT` (
  `NUMMER` int(11) NOT NULL default '0',
...
/*********************************************************
 * Table structure for table `KUNPREIS`
 ********************************************************/

CREATE TABLE `KUNPREIS` (
  `NUMMER` int(11) NOT NULL default '0',
  `ADRINR` int(11) default NULL,
  `ARTINR` int(11) default NULL,
...
/*********************************************************
 * Table structure for table `LIEFART`
 ********************************************************/

CREATE TABLE `LIEFART` (
  `NUMMER` int(11) NOT NULL default '0',
...
/*********************************************************
 * Table structure for table `NUMMERN`
 ********************************************************/
...
/*********************************************************
 * Table structure for table `RAMATRIX`
 ********************************************************/

CREATE TABLE `RAMATRIX` (
  `NUMMER` int(11) NOT NULL default '0',
  `ARTINR` int(11) default NULL,
...
/*********************************************************
 * Table structure for table `STEUER`
 ********************************************************/
...
/**
 * Data for table `STEUER`
 */

INSERT INTO `STEUER` VALUES ('00', '0.0000', 'Steuerfrei', NULL, NULL, 0, '1993-01-01', '0.0000');
INSERT INTO `STEUER` VALUES ('01', '16.0000', 'Allgemeiner Steuersatz', NULL, NULL, 0, '2007-01-01', '19.0000');
INSERT INTO `STEUER` VALUES ('02', '6.5000', 'Ermässigter Steuersatz', NULL, NULL, 0, '1993-01-01', '7.0000');
...
/**
 * Data for table `SYNEWNUMBER`
 */

INSERT INTO `SYNEWNUMBER` VALUES ('VERSART', 5);
INSERT INTO `SYNEWNUMBER` VALUES ('BHSTEUER', 6);


/*********************************************************
 * Table structure for table `VERSART`
 ********************************************************/
...
/**
 * Data for table `VERSART`
 */

INSERT INTO `VERSART` VALUES (1, 'Shop Inland (netto)', '4.1200', NULL, NULL, NULL, 1, NULL, NULL, NULL, NULL);
INSERT INTO `VERSART` VALUES (2, 'Shop Inland (brutto)', '4.9000', NULL, NULL, NULL, 1, NULL, NULL, NULL, NULL);
INSERT INTO `VERSART` VALUES (3, 'Shop Ausland (netto)', '7.4800', NULL, NULL, NULL, 1, NULL, NULL, NULL, NULL);
INSERT INTO `VERSART` VALUES (4, 'Shop Ausland (brutto)', '8.9000', NULL, NULL, NULL, 1, NULL, NULL, NULL, NULL);
INSERT INTO `VERSART` VALUES (5, 'frei', '0.0000', NULL, NULL, NULL, 1, NULL, NULL, NULL, NULL);


/*********************************************************
 * Table structure for table `VKPREIS`
 ********************************************************/

CREATE TABLE `VKPREIS` (
  `NUMMER` int(11) NOT NULL default '0',
  `ARTINR` int(11) default NULL,
...
/*********************************************************************
 * Table structure for table `pt_gsashop_supplierControl`
 ********************************************************/
...
/*********************************************************
 * Table structure for table `px_DTABUCH`
 ********************************************************/
...
/*********************************************************
 * Table structure for table `px_laender`
 ********************************************************/
...
/**
 * Data for table `px_laender`
 */

INSERT INTO `px_laender` VALUES (0, 'D', 'Deutschland', 'de', '49', '');
INSERT INTO `px_laender` VALUES (1, 'CH', 'Schweiz', 'ch', '41', '');
INSERT INTO `px_laender` VALUES (2, 'B', 'Belgien', 'be', '32', '');
INSERT INTO `px_laender` VALUES (3, 'DK', 'Dänemark', 'dk', '45', '009');
INSERT INTO `px_laender` VALUES (4, 'FIN', 'Finnland', 'fi', '358', '');
INSERT INTO `px_laender` VALUES (5, 'F', 'Frankreich', 'fr', '33', '19');
INSERT INTO `px_laender` VALUES (6, 'GR', 'Griechenland', 'gr', '30', '');
INSERT INTO `px_laender` VALUES (7, 'GB', 'Großbritannien', 'uk', '44', '010');
INSERT INTO `px_laender` VALUES (8, 'IRL', 'Irland', 'ie', '353', '16');
INSERT INTO `px_laender` VALUES (9, 'IL', 'Israel', 'il', '972', '');
INSERT INTO `px_laender` VALUES (10, 'I', 'Italien', 'it', '39', '');
INSERT INTO `px_laender` VALUES (11, 'NL', 'Niederlande', 'nl', '31', '');
INSERT INTO `px_laender` VALUES (12, 'N', 'Norwegen', 'no', '47', '095');
INSERT INTO `px_laender` VALUES (13, 'P', 'Portugal', 'pt', '351', '');
INSERT INTO `px_laender` VALUES (14, 'S', 'Schweden', 'se', '46', '009');
INSERT INTO `px_laender` VALUES (15, 'E', 'Spanien', 'es', '34', '07');
INSERT INTO `px_laender` VALUES (16, 'TR', 'Türkei', 'tr', '90', '99');
INSERT INTO `px_laender` VALUES (17, 'HU', 'Ungarn', 'hu', '36', '');
INSERT INTO `px_laender` VALUES (18, 'USA', 'Usa', 'us', '1', '011');
INSERT INTO `px_laender` VALUES (19, 'CDN', 'Kanada', 'ca', '1', '011');
INSERT INTO `px_laender` VALUES (20, 'L', 'Luxemburg', 'lu', '35', '');
INSERT INTO `px_laender` VALUES (21, 'A', 'Österreich', 'at', '43', '');
INSERT INTO `px_laender` VALUES (22, 'FL', 'Liechtenstein', 'li', '41', '');
INSERT INTO `px_laender` VALUES (23, 'CZ', 'Tschechien', 'cz', '42', '');
INSERT INTO `px_laender` VALUES (24, 'PL', 'Polen', 'pl', '48', '');
INSERT INTO `px_laender` VALUES (25, 'AL', 'Albanien', 'al', '355', '');
INSERT INTO `px_laender` VALUES (26, 'AND', 'Andorra', 'an', '367', '');
INSERT INTO `px_laender` VALUES (27, 'ARM', 'Armenien', 'am', '7', '');
INSERT INTO `px_laender` VALUES (28, 'AUS', 'Australien', 'au', '61', '');
INSERT INTO `px_laender` VALUES (29, 'BG', 'Bulgarien', 'bg', '359', '');
INSERT INTO `px_laender` VALUES (30, 'BIH', 'Bosnien Herzegowina', 'bi', '387', '');
INSERT INTO `px_laender` VALUES (31, 'BY', 'Weißrussland', 'by', '7', '');
INSERT INTO `px_laender` VALUES (32, 'CY', 'Zypern', 'cy', '357', '');
INSERT INTO `px_laender` VALUES (33, 'DZ', 'Algerien', 'dz', '213', '');
INSERT INTO `px_laender` VALUES (34, 'EST', 'Estland', 'ee', '372', '');
INSERT INTO `px_laender` VALUES (35, 'FJI', 'Fidschi', 'fj', '679', '');
INSERT INTO `px_laender` VALUES (36, 'GBZ', 'Gibraltar', 'gi', '350', '');
INSERT INTO `px_laender` VALUES (37, 'GE', 'Georgien', 'ge', '995', '');
INSERT INTO `px_laender` VALUES (38, 'HR', 'Kroatien', 'hr', '385', '');
INSERT INTO `px_laender` VALUES (39, 'IS', 'Island', 'is', '354', '');
INSERT INTO `px_laender` VALUES (40, 'J', 'Japan', 'jp', '81', '');
INSERT INTO `px_laender` VALUES (41, 'JOR', 'Jordanien', 'jo', '962', '');
INSERT INTO `px_laender` VALUES (42, 'KS', 'Kirgistan', 'ks', '7', '');
INSERT INTO `px_laender` VALUES (43, 'KZ', 'Kasachstan', 'kz', '7', '');
INSERT INTO `px_laender` VALUES (44, 'LT', 'Litauen', 'lt', '370', '');
INSERT INTO `px_laender` VALUES (45, 'LV', 'Lettland', 'lv', '371', '');
INSERT INTO `px_laender` VALUES (46, 'M', 'Malta', 'mt', '356', '');
INSERT INTO `px_laender` VALUES (47, 'MA', 'Marokko', 'ma', '212', '');
INSERT INTO `px_laender` VALUES (48, 'MC', 'Monaco', 'mc', '33', '');
INSERT INTO `px_laender` VALUES (49, 'MD', 'Moldau', 'md', '691', '');
INSERT INTO `px_laender` VALUES (50, 'NZ', 'Neuseeland', 'nz', '64', '');
INSERT INTO `px_laender` VALUES (51, 'RC', 'Taiwan', 'tw', '886', '');
INSERT INTO `px_laender` VALUES (52, 'RO', 'Rumänien', 'ro', '40', '');
INSERT INTO `px_laender` VALUES (53, 'RUS', 'Russland', 'ru', '7', '');
INSERT INTO `px_laender` VALUES (54, 'SK', 'Slowakei', 'sk', '42', '');
INSERT INTO `px_laender` VALUES (55, 'SLO', 'Slowenien', 'si', '386', '');
INSERT INTO `px_laender` VALUES (56, 'TJ', 'Tadschikistan', 'tj', '7', '');
INSERT INTO `px_laender` VALUES (57, 'TN', 'Tunesien', 'tn', '216', '');
INSERT INTO `px_laender` VALUES (58, 'TO', 'Tonga', 'to', '676', '');
INSERT INTO `px_laender` VALUES (59, 'UA', 'Ukraine', 'ua', '70', '');
INSERT INTO `px_laender` VALUES (60, 'UZB', 'Usbekistan', 'uz', '7', '');
INSERT INTO `px_laender` VALUES (61, 'VN', 'Vietnam', 'vn', '84', '');
INSERT INTO `px_laender` VALUES (62, 'YU', 'Jugoslawien', 'yu', '38', '');
INSERT INTO `px_laender` VALUES (63, 'ZA', 'Südafrika', 'za', '27', '');
INSERT INTO `px_laender` VALUES (64, 'VRC', 'Volksrepublik China', 'cn', '86', '');
INSERT INTO `px_laender` VALUES (65, 'BR', 'Brasilien', 'br', '55', '');
